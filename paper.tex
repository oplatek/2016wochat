...
\OP{describe the dataset,apologize for not having the dataset collected - promise for camera ready version.} \OD{You don't need to apologize, just state that. You can, but don't need to say how many you currently have}\\
\OP{grammar check} \\

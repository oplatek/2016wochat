...
\caption{Operator annotation interface}\OD{v obrázcích bych se snažil nějak zvětšit text (menší okno prohlížeče před printscreenem? nějak upravené CSS? nevím... zas to asi nesmí být moc práce)}
\end{center}
\vspace{-0.80em}
\label{fig:operator}
\end{figure}

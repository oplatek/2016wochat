...
\begin{abstract}
    This paper presents a datasets which contains task oriented conversation between an operator, a task expert, and a client who is seeking information about the task.
    The dataset was collected to be used for training end-to-end task oriented conversational agents just from conversations with and KB-calls from the operator.
\end{abstract}
